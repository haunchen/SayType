...
This guide covers how to set up the development environment and build SayType from source across different platforms.
...
```bash
git clone git@github.com:haunchen/SayType.git
cd SayType
```
